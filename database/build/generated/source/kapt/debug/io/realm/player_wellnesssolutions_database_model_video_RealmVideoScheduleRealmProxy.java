...
public class player_wellnesssolutions_database_model_video_RealmVideoScheduleRealmProxy extends player.wellnesssolutions.database.model.video.RealmVideoSchedule
    implements RealmObjectProxy, player_wellnesssolutions_database_model_video_RealmVideoScheduleRealmProxyInterface {

    static final class RealmVideoScheduleColumnInfo extends ColumnInfo {
        ...
        RealmVideoScheduleColumnInfo(OsSchemaInfo schemaInfo) {
            super(23);
            OsObjectSchemaInfo objectSchemaInfo = schemaInfo.getObjectSchemaInfo("RealmVideoSchedule");
        ...
        RealmVideoScheduleColumnInfo(ColumnInfo src, boolean mutable) {
            super(src, mutable);
            copy(src, this);
        }
        ...
        protected final ColumnInfo copy(boolean mutable) {
            return new RealmVideoScheduleColumnInfo(this, mutable);
        }

        @Override
        protected final void copy(ColumnInfo rawSrc, ColumnInfo rawDst) {
            final RealmVideoScheduleColumnInfo src = (RealmVideoScheduleColumnInfo) rawSrc;
            final RealmVideoScheduleColumnInfo dst = (RealmVideoScheduleColumnInfo) rawDst;
    ...
    private RealmVideoScheduleColumnInfo columnInfo;
    private ProxyState<player.wellnesssolutions.database.model.video.RealmVideoSchedule> proxyState;
    ...
    public void realm$injectObjectContext() {
        ...
        this.columnInfo = (RealmVideoScheduleColumnInfo) context.getColumnInfo();
        this.proxyState = new ProxyState<player.wellnesssolutions.database.model.video.RealmVideoSchedule>(this);
    ...
    private static OsObjectSchemaInfo createExpectedObjectSchemaInfo() {
        OsObjectSchemaInfo.Builder builder = new OsObjectSchemaInfo.Builder("RealmVideoSchedule", 23, 0);
    ...
    public static RealmVideoScheduleColumnInfo createColumnInfo(OsSchemaInfo schemaInfo) {
        return new RealmVideoScheduleColumnInfo(schemaInfo);
    }
    ...
    public static final class ClassNameHelper {
        public static final String INTERNAL_CLASS_NAME = "RealmVideoSchedule";
    }

    @SuppressWarnings("cast")
    public static player.wellnesssolutions.database.model.video.RealmVideoSchedule createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        ...
        player.wellnesssolutions.database.model.video.RealmVideoSchedule obj = realm.createObjectInternal(player.wellnesssolutions.database.model.video.RealmVideoSchedule.class, true, excludeFields);

        final player_wellnesssolutions_database_model_video_RealmVideoScheduleRealmProxyInterface objProxy = (player_wellnesssolutions_database_model_video_RealmVideoScheduleRealmProxyInterface) obj;
        if (json.has("id")) {
            if (json.isNull("id")) {
    ...
    public static player.wellnesssolutions.database.model.video.RealmVideoSchedule createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final player.wellnesssolutions.database.model.video.RealmVideoSchedule obj = new player.wellnesssolutions.database.model.video.RealmVideoSchedule();
        final player_wellnesssolutions_database_model_video_RealmVideoScheduleRealmProxyInterface objProxy = (player_wellnesssolutions_database_model_video_RealmVideoScheduleRealmProxyInterface) obj;
        reader.beginObject();
    ...
    private static player_wellnesssolutions_database_model_video_RealmVideoScheduleRealmProxy newProxyInstance(BaseRealm realm, Row row) {
        // Ignore default values to avoid creating unexpected objects from RealmModel/RealmList fields
        final BaseRealm.RealmObjectContext objectContext = BaseRealm.objectContext.get();
        objectContext.set(realm, row, realm.getSchema().getColumnInfo(player.wellnesssolutions.database.model.video.RealmVideoSchedule.class), false, Collections.<String>emptyList());
        io.realm.player_wellnesssolutions_database_model_video_RealmVideoScheduleRealmProxy obj = new io.realm.player_wellnesssolutions_database_model_video_RealmVideoScheduleRealmProxy();
        objectContext.clear();
        return obj;
    }

    public static player.wellnesssolutions.database.model.video.RealmVideoSchedule copyOrUpdate(Realm realm, RealmVideoScheduleColumnInfo columnInfo, player.wellnesssolutions.database.model.video.RealmVideoSchedule object, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (cachedRealmObject != null) {
            return (player.wellnesssolutions.database.model.video.RealmVideoSchedule) cachedRealmObject;
        }

        return copy(realm, columnInfo, object, update, cache, flags);
    }

    public static player.wellnesssolutions.database.model.video.RealmVideoSchedule copy(Realm realm, RealmVideoScheduleColumnInfo columnInfo, player.wellnesssolutions.database.model.video.RealmVideoSchedule newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (player.wellnesssolutions.database.model.video.RealmVideoSchedule) cachedRealmObject;
        }

        player_wellnesssolutions_database_model_video_RealmVideoScheduleRealmProxyInterface realmObjectSource = (player_wellnesssolutions_database_model_video_RealmVideoScheduleRealmProxyInterface) newObject;

        Table table = realm.getTable(player.wellnesssolutions.database.model.video.RealmVideoSchedule.class);
        ...
        io.realm.player_wellnesssolutions_database_model_video_RealmVideoScheduleRealmProxy realmObjectCopy = newProxyInstance(realm, row);
    ...
    public static long insert(Realm realm, player.wellnesssolutions.database.model.video.RealmVideoSchedule object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(player.wellnesssolutions.database.model.video.RealmVideoSchedule.class);
        long tableNativePtr = table.getNativePtr();
        RealmVideoScheduleColumnInfo columnInfo = (RealmVideoScheduleColumnInfo) realm.getSchema().getColumnInfo(player.wellnesssolutions.database.model.video.RealmVideoSchedule.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);
        Number realmGet$id = ((player_wellnesssolutions_database_model_video_RealmVideoScheduleRealmProxyInterface) object).realmGet$id();
        if (realmGet$id != null) {
            Table.nativeSetLong(tableNativePtr, columnInfo.idIndex, rowIndex, realmGet$id.longValue(), false);
        }
        String realmGet$tag = ((player_wellnesssolutions_database_model_video_RealmVideoScheduleRealmProxyInterface) object).realmGet$tag();
        if (realmGet$tag != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.tagIndex, rowIndex, realmGet$tag, false);
        }
        Number realmGet$brandId = ((player_wellnesssolutions_database_model_video_RealmVideoScheduleRealmProxyInterface) object).realmGet$brandId();
        ...
        String realmGet$brandTypeLogo = ((player_wellnesssolutions_database_model_video_RealmVideoScheduleRealmProxyInterface) object).realmGet$brandTypeLogo();
        ...
        Number realmGet$durationId = ((player_wellnesssolutions_database_model_video_RealmVideoScheduleRealmProxyInterface) object).realmGet$durationId();
        ...
        String realmGet$durationName = ((player_wellnesssolutions_database_model_video_RealmVideoScheduleRealmProxyInterface) object).realmGet$durationName();
        ...
        Number realmGet$languageId = ((player_wellnesssolutions_database_model_video_RealmVideoScheduleRealmProxyInterface) object).realmGet$languageId();
        ...
        String realmGet$videoName = ((player_wellnesssolutions_database_model_video_RealmVideoScheduleRealmProxyInterface) object).realmGet$videoName();
        ...
        Number realmGet$presenterId = ((player_wellnesssolutions_database_model_video_RealmVideoScheduleRealmProxyInterface) object).realmGet$presenterId();
        ...
        String realmGet$presenterName = ((player_wellnesssolutions_database_model_video_RealmVideoScheduleRealmProxyInterface) object).realmGet$presenterName();
        ...
        String realmGet$videoUrl = ((player_wellnesssolutions_database_model_video_RealmVideoScheduleRealmProxyInterface) object).realmGet$videoUrl();
        if (realmGet$videoUrl != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.videoUrlIndex, rowIndex, realmGet$videoUrl, false);
        }
        String realmGet$trailerUrl = ((player_wellnesssolutions_database_model_video_RealmVideoScheduleRealmProxyInterface) object).realmGet$trailerUrl();
        ...
        String realmGet$thumbnailLargeUrl = ((player_wellnesssolutions_database_model_video_RealmVideoScheduleRealmProxyInterface) object).realmGet$thumbnailLargeUrl();
        ...
        String realmGet$thumbnailMediumUrl = ((player_wellnesssolutions_database_model_video_RealmVideoScheduleRealmProxyInterface) object).realmGet$thumbnailMediumUrl();
        ...
        String realmGet$thumbnailSmallUrl = ((player_wellnesssolutions_database_model_video_RealmVideoScheduleRealmProxyInterface) object).realmGet$thumbnailSmallUrl();
        ...
        Float realmGet$videoLength = ((player_wellnesssolutions_database_model_video_RealmVideoScheduleRealmProxyInterface) object).realmGet$videoLength();
        ...
        Number realmGet$videoSize = ((player_wellnesssolutions_database_model_video_RealmVideoScheduleRealmProxyInterface) object).realmGet$videoSize();
        ...
        String realmGet$playTime = ((player_wellnesssolutions_database_model_video_RealmVideoScheduleRealmProxyInterface) object).realmGet$playTime();
        if (realmGet$playTime != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.playTimeIndex, rowIndex, realmGet$playTime, false);
        }
        String realmGet$downloadUrl = ((player_wellnesssolutions_database_model_video_RealmVideoScheduleRealmProxyInterface) object).realmGet$downloadUrl();
        ...
        RealmList<player.wellnesssolutions.database.model.video.RealmLanguage> languagesList = ((player_wellnesssolutions_database_model_video_RealmVideoScheduleRealmProxyInterface) object).realmGet$languages();
        if (languagesList != null) {
        ...
        RealmList<player.wellnesssolutions.database.model.video.RealmSubtitle> subtitlesList = ((player_wellnesssolutions_database_model_video_RealmVideoScheduleRealmProxyInterface) object).realmGet$subtitles();
        if (subtitlesList != null) {
        ...
        RealmList<player.wellnesssolutions.database.model.video.TinyCollectionRealm> collectionsList = ((player_wellnesssolutions_database_model_video_RealmVideoScheduleRealmProxyInterface) object).realmGet$collections();
        if (collectionsList != null) {
        ...
        RealmList<player.wellnesssolutions.database.model.video.TinyOptionRealm> levelsList = ((player_wellnesssolutions_database_model_video_RealmVideoScheduleRealmProxyInterface) object).realmGet$levels();
        if (levelsList != null) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        RealmVideoScheduleColumnInfo columnInfo = (RealmVideoScheduleColumnInfo) realm.getSchema().getColumnInfo(player.wellnesssolutions.database.model.video.RealmVideoSchedule.class);
        player.wellnesssolutions.database.model.video.RealmVideoSchedule object = null;
        while (objects.hasNext()) {
            object = (player.wellnesssolutions.database.model.video.RealmVideoSchedule) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, player.wellnesssolutions.database.model.video.RealmVideoSchedule object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(player.wellnesssolutions.database.model.video.RealmVideoSchedule.class);
    ...
    public static player.wellnesssolutions.database.model.video.RealmVideoSchedule createDetachedCopy(player.wellnesssolutions.database.model.video.RealmVideoSchedule realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        player.wellnesssolutions.database.model.video.RealmVideoSchedule unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new player.wellnesssolutions.database.model.video.RealmVideoSchedule();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (player.wellnesssolutions.database.model.video.RealmVideoSchedule) cachedObject.object;
            }
            unmanagedObject = (player.wellnesssolutions.database.model.video.RealmVideoSchedule) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        player_wellnesssolutions_database_model_video_RealmVideoScheduleRealmProxyInterface unmanagedCopy = (player_wellnesssolutions_database_model_video_RealmVideoScheduleRealmProxyInterface) unmanagedObject;
        player_wellnesssolutions_database_model_video_RealmVideoScheduleRealmProxyInterface realmSource = (player_wellnesssolutions_database_model_video_RealmVideoScheduleRealmProxyInterface) realmObject;
    ...
    public String toString() {
        ...
        StringBuilder stringBuilder = new StringBuilder("RealmVideoSchedule = proxy[");
    ...
    public boolean equals(Object o) {
        ...
        player_wellnesssolutions_database_model_video_RealmVideoScheduleRealmProxy aRealmVideoSchedule = (player_wellnesssolutions_database_model_video_RealmVideoScheduleRealmProxy)o;

        String path = proxyState.getRealm$realm().getPath();
        String otherPath = aRealmVideoSchedule.proxyState.getRealm$realm().getPath();
        if (path != null ? !path.equals(otherPath) : otherPath != null) return false;

        String tableName = proxyState.getRow$realm().getTable().getName();
        String otherTableName = aRealmVideoSchedule.proxyState.getRow$realm().getTable().getName();
        if (tableName != null ? !tableName.equals(otherTableName) : otherTableName != null) return false;

        if (proxyState.getRow$realm().getIndex() != aRealmVideoSchedule.proxyState.getRow$realm().getIndex()) return false;

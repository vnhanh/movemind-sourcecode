...
public class player_wellnesssolutions_database_model_video_VideoEntityRealmProxy extends player.wellnesssolutions.database.model.video.VideoEntity
    implements RealmObjectProxy, player_wellnesssolutions_database_model_video_VideoEntityRealmProxyInterface {

    static final class VideoEntityColumnInfo extends ColumnInfo {
        ...
        VideoEntityColumnInfo(OsSchemaInfo schemaInfo) {
            super(23);
            OsObjectSchemaInfo objectSchemaInfo = schemaInfo.getObjectSchemaInfo("VideoEntity");
        ...
        VideoEntityColumnInfo(ColumnInfo src, boolean mutable) {
            super(src, mutable);
            copy(src, this);
        }
        ...
        protected final ColumnInfo copy(boolean mutable) {
            return new VideoEntityColumnInfo(this, mutable);
        }

        @Override
        protected final void copy(ColumnInfo rawSrc, ColumnInfo rawDst) {
            final VideoEntityColumnInfo src = (VideoEntityColumnInfo) rawSrc;
            final VideoEntityColumnInfo dst = (VideoEntityColumnInfo) rawDst;
    ...
    private VideoEntityColumnInfo columnInfo;
    private ProxyState<player.wellnesssolutions.database.model.video.VideoEntity> proxyState;
    ...
    player_wellnesssolutions_database_model_video_VideoEntityRealmProxy() {
    ...
    public void realm$injectObjectContext() {
        ...
        this.columnInfo = (VideoEntityColumnInfo) context.getColumnInfo();
        this.proxyState = new ProxyState<player.wellnesssolutions.database.model.video.VideoEntity>(this);
    ...
    private static OsObjectSchemaInfo createExpectedObjectSchemaInfo() {
        OsObjectSchemaInfo.Builder builder = new OsObjectSchemaInfo.Builder("VideoEntity", 23, 0);
    ...
    public static VideoEntityColumnInfo createColumnInfo(OsSchemaInfo schemaInfo) {
        return new VideoEntityColumnInfo(schemaInfo);
    }
    ...
    public static final class ClassNameHelper {
        public static final String INTERNAL_CLASS_NAME = "VideoEntity";
    }

    @SuppressWarnings("cast")
    public static player.wellnesssolutions.database.model.video.VideoEntity createOrUpdateUsingJsonObject(Realm realm, JSONObject json, boolean update)
        ...
        player.wellnesssolutions.database.model.video.VideoEntity obj = realm.createObjectInternal(player.wellnesssolutions.database.model.video.VideoEntity.class, true, excludeFields);

        final player_wellnesssolutions_database_model_video_VideoEntityRealmProxyInterface objProxy = (player_wellnesssolutions_database_model_video_VideoEntityRealmProxyInterface) obj;
        if (json.has("id")) {
            if (json.isNull("id")) {
    ...
    public static player.wellnesssolutions.database.model.video.VideoEntity createUsingJsonStream(Realm realm, JsonReader reader)
        throws IOException {
        final player.wellnesssolutions.database.model.video.VideoEntity obj = new player.wellnesssolutions.database.model.video.VideoEntity();
        final player_wellnesssolutions_database_model_video_VideoEntityRealmProxyInterface objProxy = (player_wellnesssolutions_database_model_video_VideoEntityRealmProxyInterface) obj;
        reader.beginObject();
    ...
    private static player_wellnesssolutions_database_model_video_VideoEntityRealmProxy newProxyInstance(BaseRealm realm, Row row) {
        // Ignore default values to avoid creating unexpected objects from RealmModel/RealmList fields
        final BaseRealm.RealmObjectContext objectContext = BaseRealm.objectContext.get();
        objectContext.set(realm, row, realm.getSchema().getColumnInfo(player.wellnesssolutions.database.model.video.VideoEntity.class), false, Collections.<String>emptyList());
        io.realm.player_wellnesssolutions_database_model_video_VideoEntityRealmProxy obj = new io.realm.player_wellnesssolutions_database_model_video_VideoEntityRealmProxy();
        objectContext.clear();
        return obj;
    }

    public static player.wellnesssolutions.database.model.video.VideoEntity copyOrUpdate(Realm realm, VideoEntityColumnInfo columnInfo, player.wellnesssolutions.database.model.video.VideoEntity object, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        ...
        if (cachedRealmObject != null) {
            return (player.wellnesssolutions.database.model.video.VideoEntity) cachedRealmObject;
        }

        return copy(realm, columnInfo, object, update, cache, flags);
    }

    public static player.wellnesssolutions.database.model.video.VideoEntity copy(Realm realm, VideoEntityColumnInfo columnInfo, player.wellnesssolutions.database.model.video.VideoEntity newObject, boolean update, Map<RealmModel,RealmObjectProxy> cache, Set<ImportFlag> flags) {
        RealmObjectProxy cachedRealmObject = cache.get(newObject);
        if (cachedRealmObject != null) {
            return (player.wellnesssolutions.database.model.video.VideoEntity) cachedRealmObject;
        }

        player_wellnesssolutions_database_model_video_VideoEntityRealmProxyInterface realmObjectSource = (player_wellnesssolutions_database_model_video_VideoEntityRealmProxyInterface) newObject;

        Table table = realm.getTable(player.wellnesssolutions.database.model.video.VideoEntity.class);
        ...
        io.realm.player_wellnesssolutions_database_model_video_VideoEntityRealmProxy realmObjectCopy = newProxyInstance(realm, row);
    ...
    public static long insert(Realm realm, player.wellnesssolutions.database.model.video.VideoEntity object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(player.wellnesssolutions.database.model.video.VideoEntity.class);
        long tableNativePtr = table.getNativePtr();
        VideoEntityColumnInfo columnInfo = (VideoEntityColumnInfo) realm.getSchema().getColumnInfo(player.wellnesssolutions.database.model.video.VideoEntity.class);
        long rowIndex = OsObject.createRow(table);
        cache.put(object, rowIndex);
        Number realmGet$id = ((player_wellnesssolutions_database_model_video_VideoEntityRealmProxyInterface) object).realmGet$id();
        if (realmGet$id != null) {
            Table.nativeSetLong(tableNativePtr, columnInfo.idIndex, rowIndex, realmGet$id.longValue(), false);
        }
        String realmGet$tag = ((player_wellnesssolutions_database_model_video_VideoEntityRealmProxyInterface) object).realmGet$tag();
        if (realmGet$tag != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.tagIndex, rowIndex, realmGet$tag, false);
        }
        Number realmGet$brandId = ((player_wellnesssolutions_database_model_video_VideoEntityRealmProxyInterface) object).realmGet$brandId();
        ...
        String realmGet$brandTypeLogo = ((player_wellnesssolutions_database_model_video_VideoEntityRealmProxyInterface) object).realmGet$brandTypeLogo();
        ...
        Number realmGet$durationId = ((player_wellnesssolutions_database_model_video_VideoEntityRealmProxyInterface) object).realmGet$durationId();
        ...
        String realmGet$durationName = ((player_wellnesssolutions_database_model_video_VideoEntityRealmProxyInterface) object).realmGet$durationName();
        ...
        Number realmGet$languageId = ((player_wellnesssolutions_database_model_video_VideoEntityRealmProxyInterface) object).realmGet$languageId();
        ...
        String realmGet$videoName = ((player_wellnesssolutions_database_model_video_VideoEntityRealmProxyInterface) object).realmGet$videoName();
        ...
        Number realmGet$presenterId = ((player_wellnesssolutions_database_model_video_VideoEntityRealmProxyInterface) object).realmGet$presenterId();
        ...
        String realmGet$presenterName = ((player_wellnesssolutions_database_model_video_VideoEntityRealmProxyInterface) object).realmGet$presenterName();
        ...
        String realmGet$videoUrl = ((player_wellnesssolutions_database_model_video_VideoEntityRealmProxyInterface) object).realmGet$videoUrl();
        if (realmGet$videoUrl != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.videoUrlIndex, rowIndex, realmGet$videoUrl, false);
        }
        String realmGet$trailerUrl = ((player_wellnesssolutions_database_model_video_VideoEntityRealmProxyInterface) object).realmGet$trailerUrl();
        ...
        String realmGet$thumbnailLargeUrl = ((player_wellnesssolutions_database_model_video_VideoEntityRealmProxyInterface) object).realmGet$thumbnailLargeUrl();
        ...
        String realmGet$thumbnailMediumUrl = ((player_wellnesssolutions_database_model_video_VideoEntityRealmProxyInterface) object).realmGet$thumbnailMediumUrl();
        ...
        String realmGet$thumbnailSmallUrl = ((player_wellnesssolutions_database_model_video_VideoEntityRealmProxyInterface) object).realmGet$thumbnailSmallUrl();
        ...
        Float realmGet$videoLength = ((player_wellnesssolutions_database_model_video_VideoEntityRealmProxyInterface) object).realmGet$videoLength();
        ...
        Number realmGet$videoSize = ((player_wellnesssolutions_database_model_video_VideoEntityRealmProxyInterface) object).realmGet$videoSize();
        ...
        String realmGet$playTime = ((player_wellnesssolutions_database_model_video_VideoEntityRealmProxyInterface) object).realmGet$playTime();
        if (realmGet$playTime != null) {
            Table.nativeSetString(tableNativePtr, columnInfo.playTimeIndex, rowIndex, realmGet$playTime, false);
        }
        String realmGet$downloadUrl = ((player_wellnesssolutions_database_model_video_VideoEntityRealmProxyInterface) object).realmGet$downloadUrl();
        ...
        RealmList<player.wellnesssolutions.database.model.video.RealmLanguage> languagesList = ((player_wellnesssolutions_database_model_video_VideoEntityRealmProxyInterface) object).realmGet$languages();
        if (languagesList != null) {
        ...
        RealmList<player.wellnesssolutions.database.model.video.RealmSubtitle> subtitlesList = ((player_wellnesssolutions_database_model_video_VideoEntityRealmProxyInterface) object).realmGet$subtitles();
        if (subtitlesList != null) {
        ...
        RealmList<player.wellnesssolutions.database.model.video.TinyCollectionRealm> collectionsList = ((player_wellnesssolutions_database_model_video_VideoEntityRealmProxyInterface) object).realmGet$collections();
        if (collectionsList != null) {
        ...
        RealmList<player.wellnesssolutions.database.model.video.TinyOptionRealm> levelsList = ((player_wellnesssolutions_database_model_video_VideoEntityRealmProxyInterface) object).realmGet$levels();
        if (levelsList != null) {
    ...
    public static void insert(Realm realm, Iterator<? extends RealmModel> objects, Map<RealmModel,Long> cache) {
        ...
        long tableNativePtr = table.getNativePtr();
        VideoEntityColumnInfo columnInfo = (VideoEntityColumnInfo) realm.getSchema().getColumnInfo(player.wellnesssolutions.database.model.video.VideoEntity.class);
        player.wellnesssolutions.database.model.video.VideoEntity object = null;
        while (objects.hasNext()) {
            object = (player.wellnesssolutions.database.model.video.VideoEntity) objects.next();
    ...
    public static long insertOrUpdate(Realm realm, player.wellnesssolutions.database.model.video.VideoEntity object, Map<RealmModel,Long> cache) {
        if (object instanceof RealmObjectProxy && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm() != null && ((RealmObjectProxy) object).realmGet$proxyState().getRealm$realm().getPath().equals(realm.getPath())) {
            return ((RealmObjectProxy) object).realmGet$proxyState().getRow$realm().getIndex();
        }
        Table table = realm.getTable(player.wellnesssolutions.database.model.video.VideoEntity.class);
    ...
    public static player.wellnesssolutions.database.model.video.VideoEntity createDetachedCopy(player.wellnesssolutions.database.model.video.VideoEntity realmObject, int currentDepth, int maxDepth, Map<RealmModel, CacheData<RealmModel>> cache) {
        if (currentDepth > maxDepth || realmObject == null) {
            return null;
        }
        CacheData<RealmModel> cachedObject = cache.get(realmObject);
        player.wellnesssolutions.database.model.video.VideoEntity unmanagedObject;
        if (cachedObject == null) {
            unmanagedObject = new player.wellnesssolutions.database.model.video.VideoEntity();
            cache.put(realmObject, new RealmObjectProxy.CacheData<RealmModel>(currentDepth, unmanagedObject));
        } else {
            // Reuse cached object or recreate it because it was encountered at a lower depth.
            if (currentDepth >= cachedObject.minDepth) {
                return (player.wellnesssolutions.database.model.video.VideoEntity) cachedObject.object;
            }
            unmanagedObject = (player.wellnesssolutions.database.model.video.VideoEntity) cachedObject.object;
            cachedObject.minDepth = currentDepth;
        }
        player_wellnesssolutions_database_model_video_VideoEntityRealmProxyInterface unmanagedCopy = (player_wellnesssolutions_database_model_video_VideoEntityRealmProxyInterface) unmanagedObject;
        player_wellnesssolutions_database_model_video_VideoEntityRealmProxyInterface realmSource = (player_wellnesssolutions_database_model_video_VideoEntityRealmProxyInterface) realmObject;
    ...
    public String toString() {
        ...
        StringBuilder stringBuilder = new StringBuilder("VideoEntity = proxy[");
    ...
    public boolean equals(Object o) {
        ...
        player_wellnesssolutions_database_model_video_VideoEntityRealmProxy aVideoEntity = (player_wellnesssolutions_database_model_video_VideoEntityRealmProxy)o;

        String path = proxyState.getRealm$realm().getPath();
        String otherPath = aVideoEntity.proxyState.getRealm$realm().getPath();
        if (path != null ? !path.equals(otherPath) : otherPath != null) return false;

        String tableName = proxyState.getRow$realm().getTable().getName();
        String otherTableName = aVideoEntity.proxyState.getRow$realm().getTable().getName();
        if (tableName != null ? !tableName.equals(otherTableName) : otherTableName != null) return false;

        if (proxyState.getRow$realm().getIndex() != aVideoEntity.proxyState.getRow$realm().getIndex()) return false;

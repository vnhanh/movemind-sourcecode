...
public final class RealmObjectsToDVideosMapper {
    ...
    io.realm.RealmResults<player.wellnesssolutions.database.model.video.RealmDVideo> source) {
        return null;
    }
    
    private final player.wellnesssolutions.com.network.models.now_playing.MMVideo mapObject(player.wellnesssolutions.database.model.video.RealmDVideo source) {
        return null;
    }
    ...
    private RealmObjectsToDVideosMapper() {
        super();
    }
}
...
object VideosScheduleToRealmObjectsMapper {
    fun mapList(source: ArrayList<MMVideo>, tag: String): RealmList<RealmVideoSchedule> {
        val res = RealmList<RealmVideoSchedule>()
    ...
    private fun mapObject(source: MMVideo, groupTag: String): RealmVideoSchedule {
        val res = RealmVideoSchedule().apply {
            id = source.id
            tag = groupTag

...
class SearchByOptionImage(tag: String, title: String, @DrawableRes val imageResId: Int = -1, val width: Int, val height: Int, val innerStyle: StyleEnumInner, val bgColorStr: String = "#ffffff") :

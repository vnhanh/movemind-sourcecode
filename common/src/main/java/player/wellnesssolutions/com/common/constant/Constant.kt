...
object Constant {
    ...
    const val BUNDLE_NOT_REMOVE_VIDEO_SCHEDULE_ON_SETUP_NEXT = "BUNDLE_NOT_REMOVE_VIDEO_SCHEDULE_ON_SETUP_NEXT"
    const val BUNDLE_SOURCE_SCHEDULE = "BUNDLE_SOURCE_SCHEDULE"
    const val BUNDLE_SHOW_POPUP = "BUNDLE_SHOW_POPUP"
    const val BUNDLE_SHOW_SNACKBAR = "BUNDLE_SHOW_SNACKBAR"
